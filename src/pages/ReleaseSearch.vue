        ...
        <div class="flex flex-wrap items-center gap-2">
          ...
          <button
            ...
            :class="showAdvancedFilters
              ...
              : 'bg-neutral-50 text-neutral-600 border border-neutral-100 hover:bg-neutral-100 dark:bg-neutral-800 dark:text-neutral-400 dark:border-neutral-700 dark:hover:bg-neutral-700'"
          >
        ...
        <Transition name="panel">
          <div v-if="showAdvancedFilters" class="grid grid-cols-2 sm:grid-cols-3 gap-2 pt-1">
            ...
            <BaseSelect
              ...
              class="!bg-neutral-50 rounded-lg border border-neutral-100 dark:!bg-neutral-800 dark:border-neutral-700"
            >
              <template #prefix>
            ...
            >
              <template #prefix>
                <Icon icon="lucide:shield" class="h-3.5 w-3.5 text-neutral-400 dark:text-neutral-500" />
              </template>
            </BaseSelect>
            ...
            >
              <template #prefix>
                <Icon icon="lucide:badge-check" class="h-3.5 w-3.5 text-neutral-400 dark:text-neutral-500" />
              </template>
            </BaseSelect>
            ...
            >
              <template #prefix>
                <Icon icon="lucide:file-diff" class="h-3.5 w-3.5 text-neutral-400 dark:text-neutral-500" />
              </template>
            </BaseSelect>
            ...
            >
              <template #prefix>
                <Icon icon="lucide:circle-dollar-sign" class="h-3.5 w-3.5 text-neutral-400 dark:text-neutral-500" />
              </template>
            </BaseSelect>
            ...
            >
              <template #prefix>
                <Icon icon="lucide:mic" class="h-3.5 w-3.5 text-neutral-400 dark:text-neutral-500" />
              </template>
            </BaseSelect>
            ...
            >
              <template #prefix>
                <Icon icon="lucide:cog" class="h-3.5 w-3.5 text-neutral-400 dark:text-neutral-500" />
              </template>
            </BaseSelect>

            <!-- 发布日期范围 -->
            <div class="flex flex-col gap-1 px-2 py-1.5 rounded-lg border border-neutral-100 bg-neutral-50 dark:border-neutral-700 dark:bg-neutral-800 col-span-2 sm:col-span-3">
              ...
              <div class="flex items-center gap-2">
                ...
                <input
                  ...
                  type="date"
                  class="flex-1 rounded-md border border-neutral-200 bg-white px-2 py-1 text-xs outline-none focus:border-neutral-400 focus:ring-1 focus:ring-neutral-900/5 dark:border-neutral-700 dark:bg-neutral-900 dark:text-neutral-200"
                />
                <button
